													...
													<div class="spnc-post-wrapper">
														...
														<div class="spnc-entry-content">
															<div class="spnc-entry-meta">
																...
																<span class="date"> <i class="fa fa-solid fa-clock"></i><a <?php if (is_rtl()) { echo 'dir="rtl"'; } ?> href="<?php echo esc_url(home_url('/')); ?><?php echo esc_html(date('Y/m', strtotime(get_the_date()))); ?>" alt="<?php esc_attr_e('date-time','newscrunch'); ?>">
															...
															<div class="spnc-content-wrapper">
																<div class="spnc-post-wrapper">
																	...
																	<?php if( get_theme_mod('hide_show_banner_center_read_more',true) == true): ?>
																		<a href="<?php the_permalink();?>" class="spnc-info-link"><?php esc_html_e('Read More','newscrunch'); ?></a>
																	<?php
																	endif; 
