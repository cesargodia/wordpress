                                        ...
                                        <?php if($date=='on') { ?>
                                            <div class="spnc-entry-meta">
                                                <span class="spnc-date"> 
                                                      <a href="<?php echo esc_url(home_url('/')); ?><?php echo esc_html(date( 'Y/m' , strtotime( get_the_date('M-d-Y') )) );?>"><time ><?php echo esc_html(get_the_date( 'M '));?><?php echo esc_html(get_the_date( 'd'));?>,<?php echo esc_html(get_the_date('Y '));?></time>
                                                      </a>
                                                </span>
                                            </div>
                                        <?php } ?>
                                            ...
                                            <div class="spnc-entry-meta">   
                                                <?php if($show_auth=='on') { ?>
                                                    <span class="spnc-author">
                                                        <?php echo get_avatar( $post->post_author ); ?><a <?php if (is_rtl()) { echo 'dir="rtl"';} ?> href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>" ><?php echo esc_html(get_the_author());?></a>
                                                    </span>
                                                <?php }
                                                if($show_cat=='on') {
                                                    ...
                                                    if ( $i > 1 ){ echo esc_html( ', ' ); } ?><a <?php if (is_rtl()) { echo 'dir="rtl"';} ?> href="<?php echo esc_url( $link ); ?>"><?php echo esc_html( $term_list->name ); ?></a>
                                                    <?php $i++; }
                                                    echo '</span>';
                                                }
                                                ?>
