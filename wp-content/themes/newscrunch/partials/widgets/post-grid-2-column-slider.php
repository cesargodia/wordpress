                                    ...
                                    <div  class="spnc-post-overlay">
                                        ...
                                        <div class="spnc-entry-meta">
                                            <span class="spnc-date"> 
                                                <a <?php if (is_rtl()) { echo 'dir="rtl"';} ?> class="spnc-date-format" href="<?php echo esc_url(home_url('/')); ?><?php echo esc_html(date( 'Y/m' , strtotime( get_the_date('M-d-Y') )) );?>"><time ><?php echo esc_html(get_the_date( 'M '));?><span><?php echo esc_html(get_the_date( 'd '));?></span></time>
                                                </a>
                                            </span>
                                        </div>
                                        <?php } ?>
