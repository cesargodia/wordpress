...
.spnc-highlights-1 .spnc-container .spnc-row{
  border-right: 8px solid <?php echo esc_attr($link_color); ?>;
}
...
@media (max-width: 1100px) {
  ...
  body .spnc-custom .spnc-nav.nav > li > a:hover,body .spnc-custom .spnc-nav.nav > li > a:focus{color:<?php echo esc_attr($link_color); ?>;}
