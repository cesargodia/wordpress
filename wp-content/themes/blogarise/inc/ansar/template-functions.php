...
if (!function_exists('blogarise_archive_title')) :
    /**
     *
     * @param null
     *
    ...
    function blogarise_archive_title($title)
    {
        if (is_category()) {
...
add_filter('get_the_archive_title', 'blogarise_archive_title');



/* Display Breadcrumbs */
if (!function_exists('blogarise_excerpt_length')) :
    ...
    function blogarise_excerpt_length($length)
    {
...
add_filter('excerpt_length', 'blogarise_excerpt_length', 999);


/* Display Breadcrumbs */
if (!function_exists('blogarise_excerpt_more')) :
     ...
     * @since 1.0.0
     */
    function blogarise_excerpt_more($more)
    {
        return '...';
    }
...
add_filter('excerpt_more', 'blogarise_excerpt_more');
...
if (!function_exists('blogarise_categories_show')):
...
if (!function_exists('blogarise_archive_page_title')) :
    ...
    add_filter('get_the_archive_title', 'blogarise_archive_page_title');
...
function blogarise_social_share_post($post) {
    ...
    <div class="post-share">
        <div class="post-share-icons cf"> 
            ...
            <?php } $blogarise_blog_share_twitter_enable = get_theme_mod('blogarise_blog_share_twitter_enable','true');
            ...
            <?php } $blogarise_blog_share_email_enable = get_theme_mod('blogarise_blog_share_email_enable','true');
                if($blogarise_blog_share_email_enable == true) { ?>

            <a class="envelope" href="<?php echo esc_url("$email_url"); ?>" class="link " target="_blank" >
            <i class="fas fa-envelope-open"></i></a>
            <?php } $blogarise_blog_share_linkdin_enable = get_theme_mod('blogarise_blog_share_linkdin_enable','true');
            ...
            <?php  } $blogarise_blog_share_pintrest_enable = get_theme_mod('blogarise_blog_share_pintrest_enable','true');
                if($blogarise_blog_share_pintrest_enable == true) { ?>

            <a href="javascript:pinIt();" class="pinterest"><i class="fab fa-pinterest"></i></a>
            <?php } $blogarise_blog_share_telegram_enable = get_theme_mod('blogarise_blog_share_telegram_enable','true');
                if($blogarise_blog_share_telegram_enable == true) {?>

            <a class="telegram" href="<?php echo esc_url("$telegram_url"); ?>" target="_blank" >
            <i class="fab fa-telegram"></i>
            </a>
            <?php } $blogarise_blog_share_whatsapp_enable = get_theme_mod('blogarise_blog_share_whatsapp_enable','true');
                if($blogarise_blog_share_whatsapp_enable == true) { ?>

            <a class="whatsapp" href="<?php echo esc_url("$whatsapp_url"); ?>" target="_blank" >
            <i class="fab fa-whatsapp"></i>
            </a>
            <?php } $blogarise_blog_share_reddit_enable = get_theme_mod('blogarise_blog_share_reddit_enable','true');
